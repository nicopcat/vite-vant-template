  ...
  <div class="content">
    <div class="pb-14">
      <div class="flex flex-row w-full px-3">
        <div @click="handleFilter('1')" :class="[isActive == '1' ? 'isActive' : 'isNotActive', 'tab']">待受理</div>
        <div @click="handleFilter('2')" :class="[isActive == '2' ? 'isActive' : 'isNotActive', 'tab']">
          我进行中维修单
        </div>
      </div>
          ...
          <div v-for="(item, index) in list" class="content-box" :key="index">
            <van-cell class="flex-col">
              ...
              <template #label>
                ...
                <div class="mt-4">
                  <van-button v-permission="['app:EamRepairOngoing:view']" size="small" @click="view(item)" class="mr-2"
                    >详 情</van-button
                  >
                  <van-button
                    v-permission="['app:EamRepairOngoing:edit']"
                    size="small"
                    type="primary"
                    @click="edit(item)"
                    class="mr-2"
                  ...
                  >
                  <van-button
                    v-permission="['app:EamRepairOngoing:accept']"
                  ...
                  >
                  <van-button
                    v-permission="['app:EamRepairOngoing:complete']"
                  ...
                  >
                  <van-button
                    v-permission="['app:EamRepairOngoing:close']"
                  ...
                  >
                  <!-- <van-button
                    v-permission="['app:EamRepairOngoing:cancel']"
...
onMounted(() => {
  getDicts()
  getDevices()
  queryParams.statusList = ['WAITINGFORCOMFIRM']
...
function handleFilter(index) {
  ...
  switch (index) {
    case '1':
      ...
      break
    case '2':
      queryParams.statusList = ['WAITINGFORREPAIR', 'ONGOING']
      // queryParams.repairUser = getUserId()
      break
    default:
      Object.assign(queryParams, initialParams)
...
async function getList() {
  ...
  loading.value = true
  const request = isActive.value === '1' ? getEamRepairList : getMyEamRepairList
